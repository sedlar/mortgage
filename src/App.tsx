...
function App() {
    ...
    while (remainingAmount > 0 && realPaybacksCount < 360) {
        ...
        calendar.push({
            ...
            month: month,
            payback: Math.min(monthlyPayback, remainingAmount + realPayback + monthlyInterest),
            extraPayback: Math.max(Math.min(extraPayback, originalRemainingAmount - monthlyPayback + monthlyInterest ), 0),
